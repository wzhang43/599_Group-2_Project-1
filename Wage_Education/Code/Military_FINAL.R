...
###
### STOP === NOTE TO SELF: STOP DROPBOX FROM SYNCING BEFORE YOU RUN THIS.
###
...
for(i in 1:51) {  ## ====================== FOR LOOP ===============================
  ...
  ## Add current state to holding variable
...
## Ended up running the Download loop twice. Each time it choked, but on different states. I was able to restarted it at the same index and it usually completed that state the second time, then moved on.

## Save Data so I don't have to download it again.
...
## Wage Graph # 1 - All-in-One Error Bars === Use This one ===
...
## Wage Graph # 2 === 3 Panels - not great. ==
...
## Wage Graph # 3 - HIstogram == Meh. Worked better for full data set from single state.
...
# School Plot 1 - HIstograms == Not working for here. 
...
## School Plot #2 - Dotplot @ median w/ IQR == Use this one.
